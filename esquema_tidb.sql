-- Script de creación de base de datos para Matatucas LMS (OPTIMIZADO PARA TiDB CLOUD)
-- -----------------------------------------------------------------------------------
-- NOTA PARA TiDB CLOUD:
-- 1. Se eliminaron las sentencias CREATE DATABASE y USE ya que en TiDB Cloud
--    la base de datos se crea e inicializa a través de su consola web.
-- 2. Se eliminaron las variables del sistema SET FOREIGN_KEY_CHECKS para evitar problemas de privilegios.
-- 3. Se ordenaron los DROP TABLE en orden inverso de dependencias (hijos primero)
--    para evitar errores de restricción de llave foránea durante la limpieza.
-- -----------------------------------------------------------------------------------

-- ==========================================
-- 0. LIMPIEZA DE TABLAS (Hijos primero)
-- ==========================================
...
-- ==========================================
-- 1. CREACIÓN DE TABLAS (Padres primero)
-- ==========================================
...
CREATE TABLE `cursos` (
  ...
  INDEX `idx_cursos_docente` (`id_docente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `lecciones` (
  ...
  INDEX `idx_lecciones_curso_orden` (`id_curso`, `orden`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `videos` (
  ...
  INDEX `idx_videos_leccion` (`id_leccion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `ejercicios` (
  ...
  INDEX `idx_ejercicios_leccion` (`id_leccion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `intentos_ejercicios` (
  ...
  INDEX `idx_intento_ejercicio` (`id_ejercicio`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `lecciones_completadas` (
  ...
  INDEX `idx_comp_leccion` (`id_leccion`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `insignias_estudiantes` (
  ...
  INDEX `idx_ie_insignia` (`id_insignia`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `articulos_tienda` (
  ...
  INDEX `idx_articulos_tienda_activo` (`activo`, `tipo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `inventario_estudiante` (
  ...
  INDEX `idx_inv_articulo` (`id_articulo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `registro_auditoria` (
  ...
  INDEX `idx_auditoria_usuario_time` (`id_usuario`, `timestamp` DESC)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
